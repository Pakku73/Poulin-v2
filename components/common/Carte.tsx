    ...
    <>
      <section className="flex flex-col justify-center items-center gap-14 p-10">
        <div className="flex flex-col justify-center items-center gap-5 mt-10">
            ...
            <h1 className="uppercase font-CoreRinho75 text-black text-center text-2xl xl:text-4xl xl:text-start">RETROUVEZ-NOUS DANS NOTRE PÉPINIÈRE</h1>
            <Image
            className="mt-10"
                  ...
                  height={100}
                />
                <div className="flex flex-col justify-ceneter items-center font-CoreRinho35 xl:flex-row">
                    <p>Paris- La Queue-lez-Yvelines : <span className="font-CoreRinho65 text-RoseRed">50KM</span></p>
                    <div className="bg-black w-[2px] h-5 mx-2 rotate-90 md:rotate-0"></div>
